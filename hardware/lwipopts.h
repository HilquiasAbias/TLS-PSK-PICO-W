...
// Habilitar ALTCP para suporte a camadas de aplicação sobre TCP (necessário para TLS)
#define LWIP_ALTCP 1
#define LWIP_ALTCP_TLS 1
#define LWIP_ALTCP_TLS_MBEDTLS 1

// Aumentar memória para suportar TLS
#undef MEM_SIZE
#define MEM_SIZE 16000

// Habilitar malloc customizado para mbedTLS
